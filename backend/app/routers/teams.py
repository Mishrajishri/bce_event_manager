...
async def update_team(
    ...
    if not is_captain and not is_event_organizer and current_user.role != "admin":
        raise HTTPException(
...
async def remove_team_member(
    ...
    if not is_captain and not is_self and not is_event_organizer and current_user.role != "admin":
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
